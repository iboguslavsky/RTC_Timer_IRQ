...
Timer latency(5, false, latencyCb), blinker(100, false, blinkerCb), blinkerSlow(500, false, blinkerSlowCb), oneShot(5000, true, oneShotCb);
...
void setup () {
	...
	Serial.print("OSCHFCTRLA: 0x"); Serial.println(CLKCTRL.OSCHFCTRLA, HEX);
